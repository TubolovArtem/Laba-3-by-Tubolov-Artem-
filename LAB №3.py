...
for i in bg_0:
    for i2 in i:
        print(i2, end=' ')
    print()
# Итоговые очки выживания: сумма очков со всех предметов из рюкзака +
# + очки за ингалятор - сумма очков со всех предметов не из рюкзака - очки за антидот
